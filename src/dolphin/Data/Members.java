...
public class Members {
  List<User> Lst_of_Members;

  public Members() {
    Lst_of_Members = CreateMemberList();
  }

  private List<User> CreateMemberList() {
    List<User> Temp_list = new ArrayList<>();
    Temp_list.add(new User("Malik Delacruz", 38));
    Temp_list.add(new User("Chadwick Osborne", 18));
    Temp_list.add(new User("Alea Aguilar", 42));
    Temp_list.add(new User("Calista Conley", 13));
    Temp_list.add(new User("Kay Rutledge", 15));
    Temp_list.add(new User("Geraldine Oneil", 66));
    Temp_list.add(new User("Colleen Le", 52));
    Temp_list.add(new User("Josephine Dudley", 60));
    Temp_list.add(new User("Rinah Lindsay", 51));
    ...
    Temp_list.add(new User("Donovan Patterson", 29));
    Temp_list.add(new User("Destiny Montgomery", 39));
    Temp_list.add(new User("Benjamin Hopper", 23));
    Temp_list.add(new User("May Bolton", 16));
    Temp_list.add(new User("Hakeem Duffy", 53));
    Temp_list.add(new User("Lavinia Haynes", 43));
    Temp_list.add(new User("Hayfa Moreno", 19));
    Temp_list.add(new User("Arden Hudson", 42));
    Temp_list.add(new User("Ann Henson", 69));
    Temp_list.add(new User("Ima Meyer", 60));
    Temp_list.add(new User("Kermit Mejia", 44));
    Temp_list.add(new User("Magee Holt", 49));
    Temp_list.add(new User("Calvin Cardenas", 21));
    Temp_list.add(new User("Riley Cline", 58));
    Temp_list.add(new User("September Wyatt", 38));
    ...
    Temp_list.add(new User("Lillian Greer", 65));
    Temp_list.add(new User("Flynn Burt", 64));
